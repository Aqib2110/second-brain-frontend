...
const signupobj:signupprops = {
  ...
  password:val2
    ...
    const data = await fetch('https://second-brain-backend-zzh3.vercel.app/api/v1/signup',{
      method:"POST",
      headers: {
...
navigate('/signin');
  ...
  return (
    <div className='bg-gray-600 flex flex-col justify-center items-center h-screen w-screen'>
      <h1 className='font-bold pb-3 text-white text-3xl'>Sign up</h1>
      <div className='bg-white rounded-md  justify-center  flex flex-col px-5 md:px-15 gap-4 w-4/5 md:w-1/3 h-2/4'>
